...
[阿里云镜像站](https://mirrors.aliyun.com/apache/hadoop/common/?spm=a2c6h.25603864.0.0.9f0b506eJosOB1)

```bash
wget https://mirrors.aliyun.com/apache/hadoop/common/hadoop-3.4.2/hadoop-3.4.2.tar.gz
```

[阿里云镜像站](https://mirrors.aliyun.com/apache/hbase/)

```bash
wget https://mirrors.aliyun.com/apache/hbase/2.6.4/hbase-2.6.4-bin.tar.gz
```

[阿里云镜像站](https://mirrors.aliyun.com/apache/zookeeper/?spm=a2c6h.25603864.0.0.41393240wn0lkU)
