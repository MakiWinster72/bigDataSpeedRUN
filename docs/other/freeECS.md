...
3. 申请试用
![](https://img.makis-life.cn/images/20251110181147260.png)
> [!note]
> 若有ECS服务器，地域可以选择与ECS相同区域。
> 》》实验要求 MySQL 5.6 但高可用只能选择 MySQL 8.0, 其实 8.0 也可以完成实验。

![](https://img.makis-life.cn/images/20251110181147261.png)
> [!warning]
...
![](https://img.makis-life.cn/images/20251110181147262.png)
